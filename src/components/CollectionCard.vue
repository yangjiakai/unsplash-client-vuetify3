      ...
      <router-link :to="`/apps/unsplash/collection/${collection.id}`">
        <div class="card-top">
          <v-row no-gutters>
            <v-col cols="8">
              <v-img
                height="304" aspect-ratio="1/2" cover :src="collection.cover_photo.urls.small"
            ...
            <v-col cols="4">
              <div class="flex-1 pb-1">
                <v-img
                  height="150" cover :src="collection.preview_photos[1].urls.small"
                  :lazy-src="collection.preview_photos[1].urls.small" class="mb-1"
                />
                <v-img
                  height="150" cover :src="collection.preview_photos[2].urls.small"
